    ...
    <body>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ url('/clientes/registro') }}" method="POST" enctype="multipart/form-data">
                    @csrf

                    <div class="mb-3">
                        <label for="cedula_cliente" class="form-label">Cédula</label>
                        <input type="text" class="form-control @error('cedula_cliente') is-invalid @enderror"
                            id="cedula_cliente" name="cedula_cliente" value="{{ old('cedula_cliente') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('telefono_cliente') is-invalid @enderror"
                            id="telefono_cliente" name="telefono_cliente" value="{{ old('telefono_cliente') }}">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('direccion_cliente') is-invalid @enderror"
                                id="direccion_cliente" name="direccion_cliente" value="{{ old('direccion_cliente') }}">
