...
<body>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{route('actualiza_categoria', $categorias->categoriaID)}}" method="POST">
                @csrf
                <!-- <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('categoria_id') is-invalid @enderror" 
                        id="categoria_id" name="categoria_id" value="{{ old('categoria_id', $categorias->categoriaID) }}">
                    @error('categoria_id')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('nombre_categoria') is-invalid @enderror" 
                        id="nombre_categoria" name="nombre_categoria" value="{{ old('nombre_categoria', $categorias->nombreCategoria) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('descripcion_categoria') is-invalid @enderror" 
                        id="descripcion_categoria" name="descripcion_categoria" value="{{ old('descripcion_categoria', $categorias->descripcionCategoria) }}">
